...
abstract class BaseClass(
    ...
    // Если у нас функция будет публичной мы бы не смогли обратиться в мейне
    ...
    //  Если у нас функция будет публичной мы бы не смогли обратиться в мейне ,не могут видеть наследники
